...
$query = "SELECT pk_cancion, cancion FROM cancion";
  ...
  <div class="song-list">
    ...
    <?php if ($resultado->num_rows > 0): ?>
      <?php while ($fila = $resultado->fetch_assoc()): ?>
        <div class="song-item">
          <a href="reproductor.php?cancion=<?php echo urlencode($fila['cancion']); ?>">
            <?php echo htmlspecialchars(pathinfo($fila['cancion'], PATHINFO_FILENAME)); ?>
          </a>
        </div>
      <?php endwhile; ?>
    <?php else: ?>
