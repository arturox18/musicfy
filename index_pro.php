...
<body>
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            <a href="juego.html" class="nav-link minijuego">Minijuego</a>
    ...
    <div class="sidebar">
        ...
        <nav>
            <?php if ($resultado_artista->num_rows > 0): ?>
                ...
                <a href="mis_albums2.php?pk_usuario=<?= $pk_usuario ?>" class="sidebar-link">Ver mis Álbumes</a>
            ...
            <?php endif; ?>
            <a href="index_cancion2.php" class="sidebar-link">Todas las canciones</a>
        </nav>
    </div>
